...
/**
 * Author: walid
 * Date ： 2015/11/13 14:25
 */
public class SMRelativeLayout extends RelativeLayout implements InitParamsInterface {
	...
	public SMRelativeLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		this.context = context;
		viewParamsModel = LayoutParamsUtils.getLayoutParams(context, attrs);
	}

	public SMRelativeLayout(Context context, AttributeSet attrs, int style) {
